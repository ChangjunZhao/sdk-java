...
import com.huawei.openstack4j.openstack.vpc.domain.SecurityGroupRule;
...
public class SecurityGroupTest extends AbstractTest {
	...
	public void testListSecurityGroups() throws IOException, InterruptedException {
		respondWith("/vpc/list_securitygroup_response.json");
	...
	@Test
	public void testCreateSecurityGroup() throws IOException, InterruptedException, JSONException {
		respondWith("/vpc/create_get_securitygroup_response.json");
		
		SecurityGroup sg = SecurityGroup.builder().name("qq").description("qq").vpcId("3ec3b33f-ac1c-4630-ad1c-7dba1ed79d85").build();
		...
		RecordedRequest request = server.takeRequest();
		JSONAssert.assertEquals("{ \"security_group\": { \"name\":\"qq\", \"description\": \"qq\", \"vpc_id\" : \"3ec3b33f-ac1c-4630-ad1c-7dba1ed79d85\" } }",
