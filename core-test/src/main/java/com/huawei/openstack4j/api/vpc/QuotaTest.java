...
import com.huawei.openstack4j.openstack.vpc.domain.Resource;
import com.huawei.openstack4j.openstack.vpc.domain.Resource.Quotas;
import com.huawei.openstack4j.openstack.vpc.domain.Vpc;
import com.huawei.openstack4j.openstack.vpc.domain.VpcCreate;
...
public class QuotaTest extends AbstractTest {
	...
	public void testListQuotas() throws IOException, InterruptedException {
		respondWith("/vpc/list_quota_response.json");
